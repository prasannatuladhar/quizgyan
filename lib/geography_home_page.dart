...
import 'quizBrainGeography.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

class GeographyHomePage extends StatefulWidget {
  @override
  _GeographyHomePageState createState() => _GeographyHomePageState();
}

class _GeographyHomePageState extends State<GeographyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Geography Category Questions')),
