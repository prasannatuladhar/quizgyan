...
import 'quizBrainLiterature.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

class LiteratureHomePage extends StatefulWidget {
  @override
  _LiteratureHomePageState createState() => _LiteratureHomePageState();
}

class _LiteratureHomePageState extends State<LiteratureHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Literature & Language Category Questions')),
